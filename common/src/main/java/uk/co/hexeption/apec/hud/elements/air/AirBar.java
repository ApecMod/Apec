...
public class AirBar extends Element {
    ...
    public void drawText(GuiGraphics graphics, boolean editMode) {
        ...
        // Empty Bar
        graphics.blit(RenderType::guiTexturedOverlay, airBarTexture.getResourceLocation(),
                width, height,
                0, 40, 182, 5,
    ...
    public Vector2f getAnchorPointPosition() {
        return menu.applyGlobalChanges(this, new Vector2f(mc.getWindow().getGuiScaledWidth() - 190, 72));
    }
