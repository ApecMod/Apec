    ...
    public void drawText(GuiGraphics graphics, boolean editMode) {
        ...
        if (Apec.INSTANCE.settingsManager.getSettingState(SettingID.SHOW_SKILL_XP)) {
            ...
            if (ps.skill_shown()) {
                ...
                graphics.blit(RenderType::guiTextured, skillBarTexture.getResourceLocation(),
                ...
                switch (skillType) {
                    case NONE, FARMING -> graphics.blit(RenderType::guiTextured, skillBarTexture.getResourceLocation(),
                            (int) skillBarPos.x, (int) skillBarPos.y,
                            0, 5, (int) skillProgress, 5, skillBarTexture.getWidth(), skillBarTexture.getHeight());
                    case COMBAT -> graphics.blit(RenderType::guiTextured, skillBarTexture.getResourceLocation(),
                            (int) skillBarPos.x, (int) skillBarPos.y,
                            0, 15, (int) skillProgress, 5, skillBarTexture.getWidth(), skillBarTexture.getHeight());
                    case MINING -> graphics.blit(RenderType::guiTextured, skillBarTexture.getResourceLocation(),
                            (int) skillBarPos.x, (int) skillBarPos.y,
                            0, 25, (int) skillProgress, 5, skillBarTexture.getWidth(), skillBarTexture.getHeight());
                    case FORAGING -> graphics.blit(RenderType::guiTextured, skillBarTexture.getResourceLocation(),
                            (int) skillBarPos.x, (int) skillBarPos.y,
                            0, 35, (int) skillProgress, 5, skillBarTexture.getWidth(), skillBarTexture.getHeight());
                    case ENCHANTING -> graphics.blit(RenderType::guiTextured, skillBarTexture.getResourceLocation(),
                            (int) skillBarPos.x, (int) skillBarPos.y,
                            0, 45, (int) skillProgress, 5, skillBarTexture.getWidth(), skillBarTexture.getHeight());
                    case FISHING -> graphics.blit(RenderType::guiTextured, skillBarTexture.getResourceLocation(),
                            (int) skillBarPos.x, (int) skillBarPos.y,
                            0, 55, (int) skillProgress, 5, skillBarTexture.getWidth(), skillBarTexture.getHeight());
                    case ALCHEMY -> graphics.blit(RenderType::guiTextured, skillBarTexture.getResourceLocation(),
                            (int) skillBarPos.x, (int) skillBarPos.y,
        ...
        if (editMode) {
            graphics.blit(RenderType::guiTextured, ApecTextures.SKILL_BAR.getResourceLocation(),
                    (int) skillBarPos.x, (int) skillBarPos.y,
